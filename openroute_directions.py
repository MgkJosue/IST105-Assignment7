...
key = "eyJvcmciOiI1YjNjZTM1OTc4NTExMTAwMDFjZjYyNDgiLCJpZCI6Ijc2ZTIwYjI4NWMwZDQ3ZjNiMjUzNmM2YWVmNzgwMTIzIiwiaCI6Im11cm11cjY0In0="
...
# Step 4: Add User Input Functionality
while True:
    ...
    # Step 6: Construct the JSON Body and Make the POST Request
    ...
    # Step 7: Parse and Display Trip Information
    if response.status_code == 200:
